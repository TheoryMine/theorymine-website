...
<p>
In operating our website we may collect and process the following data about you: <ol>
...
<li>
  ...
  <ol>
    ...
    <ol>
      <li>information that you submit by filling in forms on our site;</li>
      <li>information submitted at the time of registering with our site or requesting products from us;</li>
      <li>information you provide when you report a problem with our site;
      <li>information concerning your use of our site and the products you purchase from us;</li>
      <li>information you submit to our service providers, including without limitation through the website of our chosen payment services provider (the &#8220;payment website&#8221;);</li>
      <li>information concerning your use of the payment website and the payment method chosen by you upon the payment website;</li>
      material including comments, reviews and recommendations you submit to our site;</li>
      <li>information concerning your compliance with the terms and conditions relating to the use of our site;</li>
      <li>information you provide when you contact us, including a copy of and records concerning any correspondence;</li>
      <li>information we may record concerning your communications with us for quality control and training purposes;</li>
      <li>information you provide when complete surveys that we use for research purposes; and</li>
    ...
    <li>We may collect this information into a file specific to you.</li>
    <li>If you submit information through or otherwise to our site, we may additionally collect and process information on any individuals identified therein or identifiable therefrom.</li>
  </ol>
</li>
<li>
IP addresses and cookies
  <ol>
  <li>We may collect (or procure the collection of) information about your computer, including, where available, your IP address (a unique identifier for your computer or other access device), operating system (for example, Microsoft Windows XP or Macintosh OS X) and browser type (for example, Microsoft Internet Explorer or Mozilla Firefox), for system administration and to report aggregate information.  This is statistical data about our users&rsquo; browsing actions and patterns, and does not identify any individual.
  </li>
  <li>
  ...
  <li>
  If you want to delete any cookies, please refer to the instructions for your file management software to locate the file or directory that stores cookies. Our cookies will contain the domain name theorymine.co.uk within their internet address.</li>
  <li>You may refuse to accept cookies by activating the setting on your browser which allows you to refuse the setting of cookies.  However, if you select this setting, you may be unable to access certain parts of our site.  Unless you have adjusted your browser setting so that it will refuse cookies, our system will issue cookies when you log on to our site.</li>
  </ol>
</li>
<li>
Where we store personal data
  <ol>
  <li>
  The information that we collect (or procure the collection of) from or concerning you or which you submit to us may be transferred to, and stored at, a destination outside the European Economic Area (&#8220;EEA&#8221;). It may also be processed by staff operating outside the EEA who work for us or for one of our service providers.  By submitting information, you agree to this transfer, storing or processing (which may include transfers to, or storing or processing in countries or jurisdictions who do not provide the same level of data protection as the United Kingdom).  If you are submitting the information concerning another individual, you confirm that that person is aware of, and has explicitly consented to, any such transfers. We will take all steps reasonably necessary to ensure that personal data is treated securely and in accordance with this privacy and cookie policy and will, if appropriate, put a contract in place to ensure that personal data is protected.</li>
  <li>
...
Uses made of the information
  ...
  We use the information that we collect (or procure the collection of) from or concerning you or which you submit to us in the following ways:
    <ol>
    <li>to enable the proper maintenance and / or operation of our site;
    to ensure that content from our site is presented in the most effective manner for you and for your computer;</li>
    <li>to provide you with information or products that you request from us;</li>
    <li>to maintain a publicly available register of products purchased from us;</li>
    <li>to provide you with information concerning products made available by us;</li>
...
<li>
  ...
  We may disclose the information that we collect (or procure the collection of) from or concerning you or which you submit to us:
    ...
    <li>to maintain and make available to the public a register of products purchased from us;</li>
    <li>to any member of our group, which means our subsidiaries, our ultimate holding company and its subsidiaries, as defined in section 1159 of the UK Companies Act 2006;</li>
    <li>in the event that we sell or buy any business or assets, to the prospective seller or buyer of such business or assets;</li>
    <li>to comply with any legal or contractual obligation;</li>
    <li>to enable or facilitate the exercise of our rights under the terms and conditions relating to the use of our site; or </li>
    <li>to protect our rights, property, or safety, or others where such disclosure may include exchanging information with other companies and organisations for the purposes of fraud prevention.</li>
    </ol>
  </li>
  </ol>
</li>
...
Third party personal data
  <ol>
  <li>
  Where you submit information regarding another person, you confirm that they have consented to you acting for them and to the processing of their personal data, and that you have informed them of our identity and the content of the terms and conditions relating to the use of our site and this privacy and cookie policy, including the purposes for which their personal data will be processed by us and that they have explicitly consented to our use and processing of their personal data (including sensitive personal data).</li>
  <li>Our terms and conditions of website use and this privacy and cookie policy will apply to any such third party personal data in the same manner that they apply to your own personal data.</li>
  </ol>
</li>
<li>
Your rights
...
Access to information
  <ol>
  The Act gives you the right to access information held about you.  Your right of access can be exercised in accordance with the Act.  Any access request may be subject to a fee of &pound;10.00 to meet our costs in providing you with details of the information we hold about you.  You also have the right to have any inaccuracies corrected in the personal data that we hold about you.
  </ol>
</li>
<li>
Changes to our privacy and cookie policy
  <ol>
  Any changes we may make to our privacy and cookie policy in the future will be posted on this page.
  </ol>
</li>
