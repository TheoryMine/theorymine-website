...
if( (! $bad_entry) and $some_entry){
  ...
  if($giftlock != null and $giftid != null) {
    get_where("SELECT p1.*, r.id as r_id, p2.id as lock_id, p2.title as lock_code, p2.body as msg FROM $db_points as p1, $db_points as p2, $db_relations as r WHERE p1.point_type = 'thm.gifted' AND p1.id = '$giftid' AND r.dst_obj_id = p1.id AND r.relation_type = 'lock' AND src_obj_id = p2.id AND p2.point_type = 'lock'");
