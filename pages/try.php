...
<br>
<br>
f<sub>&#950;&#968;</sub> : T<sub>2</sub> &times;  T<sub>9</sub> &#8594; T<sub>2</sub>

</td></tr></table>
<table>
<tr><td width="48%" align="right">
  f<sub>&#950;&#968;</sub>(C<sub>c</sub>(x, y), z)
</td><td width="4%" align="center">=</td><td width="48%" align="left">
  C<sub>c</sub>(x, x)
</td></tr>
<tr><td width="48%" align="right">
  f<sub>&#950;&#968;</sub>(C<sub>d</sub>(x, y), z)

</td><td width="4%" align="center">=</td><td width="48%" align="left">
  C<sub>d</sub>(f<sub>&#950;&#968;</sub>(x, z), y)
</td></tr>
</table>
';
  ...
  $trytry='964 aelig';
   $string2= str_replace((array_keys($latex_remplacements)),(array_values($latex_remplacements)),   $trytry); 
  
  $thy_body3 =  replace_html_structure($trytry, $latex_remplacements);
...
print "<br>";
//print "thybody3 : " . $thy_body3;
print "1 : " . $thy_parts[1];
print "<br>";
print "2 : " . $thy_body2;
print "<br>";
print "3 : " . $thy_parts2[0];
print "<br>";
print "4 : " .  $datatype1;
print "<br>";
print "5 : " . $thy_parts2[1];
print "<br>";
print "6 : " . $datatype2;
//print (remplace_contries($rempl));
