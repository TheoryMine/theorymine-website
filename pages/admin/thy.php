...
if($act == "show-edit-thy"){
  ...
  <a class="greenbutton" href="?go=admin&s=thy&act=touch&obj_id=<? print($point['id']); ?>" method="post">Update time</a> 
  <br><br> -->
  To <span class="warning">delete</span> the theory: 
  <a class="redbutton" href="?go=admin&s=thy&act=delete-thy&point_id=<? print($point['id']); ?>" method="post">Delete theory</a>
