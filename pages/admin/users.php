...
if($act == "show-edit-user"){
  ...
  <a class="redbutton" href="?go=admin&s=users&act=lock-user&user_id2=<? print($user['id']); ?>">lock user</a>
  <br><br>
  To <span class="warning">delete</span> the user:
  <a class="redbutton" href="?go=admin&s=users&act=delete-user&user_id2=<? print($user['id']); ?>">Delete User</a>
