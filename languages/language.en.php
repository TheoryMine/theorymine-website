...
$lang = array (
  ...
  'overview_title'  => 'TheoryMine lets you name a personalised, newly discovered, mathematical theorems as a novelty gift.',
  'overview_tagline' => 'Name your very own mathematical theorem, newly discovered by one of the world\'s most advanced computerised theorem provers (a kind of robot mathematician), and
you can immortalise your loved ones, teachers, friends and even yourself and your favourite pets.',
  'overview_see_example' => 'See an example theorem certificate',
  'overview_you' => 'YOU',
  'overview_we' =>'WE',
  'overview_they' => 'THEY',
  'overview_you2'=> 'choose a name',
  'overview_we2'=> 'discover a theorem',
  'overview_they2' => 'get a great gift',
   'overview_get_started' => 'Get Started:',
  'overview_choose' =>'Choose your Theorem Name',
  'overview_preview' => 'Preview your theorem!',
  'overview_eg' => 'e.g. Tom\'s theorem, or The Bucklesham lemma',
  ...
  'discover_tc2' => 'Terms and Conditions of the TheoryMine website',
  'discover_sub1' => 'Once your order has been placed, you will receive a user name and password to',
  'discover_sub2' => 'to this website. You can login at any time to view the status of your order, view the theorems you have named,  as well as download the certificate for these theorems.',
    'discover_sub3' => 'Theorems are discovered by our robot mathematicians, we make every effort to ensure that the discovered theorems have never been published before, and we guarantee that every theorem we discover has not been previously recorded in our database of theorems. In the unlikely event that that there is a mathematics article publishing the theorem prior to our discovery, then we will give two additional new theorems to the owner of the old theorem. For more information on how we ensure that our discovered mathematics is new, see the',
    'discover_choose2' => 'Choose the language for your brochure and emails:',

      'discover_voucher' => 'Got a voucher?',
  'discover_confirm' => 'confirm',
  'discover_voucher_valid' => 'discount voucher, ONLY £5 per theorem now! ',
  'discover_voucher_invalid' => 'invalid',
  'discover_5'=> 'Only &pound;5.00',

    //faq

  'faq_title' => 'F.A.Q.',
  'faq_about' =>'WHO IS THEORYMINE? (about us!)',
  'faq_sec1' => 'About your purchase',
  'faq_sec2' => 'About how TheoryMine works',
  'faq_q1' => 'WHAT CAN I BUY FROM THEORYMINE?',
  'faq_q2' => 'WHAT IS GOING TO HAPPEN WHEN I PURCHASE A THEOREM?',
  'faq_q3' => 'WILL I BE ABLE TO PURCHASE EXTRA ITEMS WITH MY THEOREM ONCE I PURCHASED MY THEOREM?',
  'faq_q4' => 'CAN I CHOOSE THE THEOREM I NAME?',
  'faq_q5' => 'CAN I CHANGE THE NAME OF MY THEOREM AFTER IT HAS BEEN PURCHASED?',
  'faq_q6' => 'WHAT CAN I CALL A THEOREM?',
  'faq_q7' => 'WHICH METHODS OF PAYMENT DO YOU ACCEPT?',
  'faq_q8' => 'WHY HASN\'T MY THEOREM ARRIVED BY THE DEADLINE YOU PROMISED?',
  'faq_q9' => 'WHY IS MY CERTIFICATE NOT FORMATTED CORRECTLY?',
  'faq_q10' => 'WHAT IS A THEORY?',
  'faq_q11' => 'WHAT IS A THEOREM?',
  'faq_q12' => 'WHAT IS A RECURSIVE DEFINITION?',
  'faq_q13' => 'WHAT KIND OF THEOREM DOES THEORYMINE DISCOVER?',
  'faq_q14' => 'HOW CAN I BE SURE THAT THE PROOF OF MY THEOREM IS CORRECT?',
  'faq_q15' => 'HOW IS IT POSSIBLE TO GENERATE THEOREMS?',
  'faq_q16' => 'HOW CAN I BE SURE MY THEOREM IS ORIGINAL?',
  'faq_q17' => 'HOW CAN I BE SURE THAT MY THEOREM IS NOT TRIVIALLY TRUE?',
  'faq_q18' => 'IS MY THEOREM INTERESTING?',
  ...
  'faq_a6' => 'You can call a Theorem whatever you like as long as the name its not inappropriate, libellous, defamatory, blasphemous, obscene, offensive to public morality or an incitement to racial hatred or terrorism.',
  'faq_a7' => 'Payments are carried out on our behalf by PayPal, one of the most popular, secure and established payment gateways. PayPal\'s pages offer the highest level of security and encryption. Users should be reassured by the internet standard padlock symbol which will be displayed whilst you are entering your card details. We do not hold or see your card details as these are processed directly by PayPal.',
  'faq_a8' => 'Note that if you are not logged into your account when you purchase from our website, your notification email will come to <em>the email address you have registered with PayPal</em>. Please check <em>that email account</em> to see if your notifications emails have arrived. If so, you will also be able to log into the TheoryMine website using the user name and password we have sent you. If your notification email has not arrived by the deadline we specify above or, if it has, but your certificate is not available at &quot;View Certificate&quot; when you log in, then please email us at support@theorymine.co.uk and we will find out what has gone wrong asap.',
  'faq_a9' => 'Some PDF readers might not support the mathematical characters that appear in the certificate. You might not see these characters when you open the certificate or when you print it. However, if you use Adobe Reader (available for free <a href="http://get.adobe.com/reader/">here</a>) you will not have any of these problems.',
  ...
  'faq_a15' => 'TheoryMine is based on decades of world-class research into automated reasoning and artificial intelligence at the Universities of Edinburgh, Cambridge and Munich.  It uses the grammars of theories and theorems to generate candidates, filters out the obviously false and uninteresting ones, and then uses automated reasoning to see which of the remainder it can prove.',
  'faq_a16' => 'The TheoryMine program constructs brand new mathematical theories, that no-one has previously developed by using brand new recursive functions and recursive objects. By definition, all theorems of these new theories are themselves brand new.',
  'faq_a17' => 'There are two senses in which your theorem is not trivially true. Firstly, note that some mathematical theories are inconsistent i.e. the axioms contradict each other. In such theories all formulae are theorems, which is clearly undesirable. However, it is a well-established mathematical result that theories consisting only of recursive definitions, as TheoryMine\'s theories are, are inherently consistent. So you can be sure that your theorem is not trivial in this sense. The second sense in which these theorems are not trivially true is that they cannot be directly derived by a simple calculation. In particular, they are not true by simple rewriting from other known theorems, as described in more detail in the answer to the question: <a href="#interesting">IS MY THEOREM INTERESTING?</a>.',
  'faq_a18' => 'TheoryMine applies a series of filters to remove uninteresting theorems before it generates them. On the other hand, don\'t expect your theorem to earn you the Fields Medal! (the Nobel Prize of Mathematics). In particular, we use the notion of interesting initially developed in <a href="http://www.springerlink.com/content/bk711q2u247mr967">Conjecture Synthesis for Inductive Theories (Journal of Automated Reasoning)</a>
which was then further developed in
<a href="http://www.springerlink.com/content/m885557421m7418m">Scheme-Based Synthesis of Inductive Theories (LNCS, Volume 6437)</a>. Technically, this ensures that standard orderings, using known theorems as rewrites, cannot prove the new theorem: that there is no direct symbolic calculational proof of the new theorem.',
  'faq_a19' => 'It is a long-standing tradition in mathematics that the author of a new theorem has the authority to name it. TheoryMine assigns that authority to you.',
  'faq_a20' => 'A theorem, once proved, stays proved for ever. The reasoning in the proof is deductive, so contains no element of probability or uncertainty. Theorems are abstract objects that are not subject to wear and tear. Even diamonds will be destroyed in the heat death of the universe; theorems won\'t be.',

  //about

  'about_title' => 'About Us:',
  'about_p1' =>'Theory<font color="#b4975a">Mine</font> is a company dedicated to <a href="http://dream.inf.ed.ac.uk/events/automatheo-2010/">automated theory exploration</a>: we develop artificial intelligence techniques to discover new mathematical concepts and automate proof. By providing some fun applications of theorem proving (e.g. <a href="?go=discover">naming new theorems!</a>), we sponsor more serious applications of automated reasoning technology. In particular, we are working on verification tools to make software more reliable and safe to use, as well as tools to ease the exploration of new mathematical concepts',
  'about_p2' =>'Our software builds on decades of research by the international community in automated reasoning, notably the work in <a href="http://itp2011.cs.ru.nl/ITP2011/Home.html">interactive theorem proving</a> as well as <a href="http://cade23.ii.uni.wroc.pl/">automated deduction</a>. They provide amazing software which deserves to be more widely used and appreciated.',
  'about_p3' =>'TheoryMine was started by a group of researchers in the <a href="http://www.ed.ac.uk/schools-departments/informatics/">School of Informatics</a> at <a href="http://www.ed.ac.uk/">University of Edinburgh</a>, we are:',
  'about_alan' => 'Managing Director of TheoryMine and Professor of Automated Reasoning in the School of Informatics, University of Edinburgh, FRS, FREng, FACM.',
  'about_fla' => 'Graduated in Artificial Intelligence and Mathematics from the University of Edinburgh. ',
  'about_lucas' => 'Formerly CTO of TheoryMine and senior researcher with the Mathematical Reasoning Group, part of the Centre for Intelligent Systems and their Applications, in the School of Informatics, at the University of Edinburgh.',
  'about_moa' => 'Assistant professor at Chalmers University of Technology in Gothenburg, Sweden. She did her PhD in the Mathematical Reasoning Group at the University of Edinburgh.',
  'about_roy' => 'Senior Research Fellow at the School of Informatics, University of Edinburgh and member of the Centre for Intelligent Systems and their Applications.',

  //products

  'gift_title'=>'Gift Packs:',
   'gift_p1' =>'When you name a  theorem you attach your name to something that will survive throughout history.',
  'gift_p2' =>'The creation of a working mathematical theorem or law usually requires extensive work by a rare and brilliant mind. This gives the creator the right to have the theorem take their name; names like Gauss, Fermat and Pythagoras. Now anyone who wants to have their name immortalised along with the giants of maths and science can do so. This is possible thanks to a system that generates and proves completely new theories and theorems.The theorems that we produce are guaranteed to be unique, because we generate them from unique theories. Inductive theories are guaranteed to be consistent, by design, so the generated  theorems are not spuriously true.',
  'gift_p3' =>'You can name a new theorem however you like and you will be able to decide if you would like to have a certificate detailing your theorem delivered to you, have it published in our journal, and even have it printed on a t-shirt!',
  'gift_h1' =>'NAME A THEOREM + PDF CERTIFICATE: <font color="#b4975a">&pound;15</font>',
  'gift_h2' =>'GIFT ITEMS:',
  ...
  'tes_title' => 'Testimonials:',
  'tes_p1' => '"This really captured my imagination and I&#39;m delighted to buy TheoryMine&#39;s first Theorem.  What an inventive use of Scotland&#39;s expertise in artificial intelligence to create such a novel and fun product"',
  'tes_p2' => '"During my time as an eager undergraduate mathematician, I\'d often wonder what it would feel like to prove a truly new result and have my name immortalised in the mathematical history books. I thought that dream had died when I gave up maths to become a science writer, but Aron\'s theorem is now a reality"',
  'tes_p3' => '"This is a superb example of innovation and creation."',
  'tes_p4' => '"The theorems start at &pound;15 each; &pound;20 cheaper than changing your name to Pythagoras by deed poll"',
  'tes_p5' => '"This year\'s naming gift is this ingenious (or possibly even genius) one."',
  'tes_p6' => '"It&#39;s never too early to start enjoying maths, and this is a present that will last a lifetime."',
  'tes_p7' => 'Listen to BBC\'s Material World Interview',

   //Abuse

   'abuse' => 'Thank your reporting abuse of the system. We will do our best to investigate the incident.',

   //Bad_cert_id

   'badid_title' => 'Bad certificate id',
   'badid_p' => 'It looks like you entered a incomplete or incorrect certificate link. Please check your certificate link. If you continue to have a problem, please',

   //Cancellation

   'canc_title' => 'Cancellation Policy',
   'canc_p' => 'When you buy from TheoryMine your theorem is produced specifically for you. Therefore you can cancel at any time before production begins. All you have to do is email us on support@theorymine.co.uk and we will get your money refunded and order cancelled. If production has begun then unfortunately we cannot refund your order. If your order is not satisfactory (i.e.-theorem is not unique) then you can certainly let us know and have your theorem refunded.',

   //Timeout

   'timeout_title' => 'You have been logged out',
   'timeout_p1' => 'You get automatically logged out after ',
   'timeout_p2'=> ' minutes of inactivity, or if you try to access a restricted page. To continue, <a target="_blank" href="?go=login">login again</a>; this login link will open in another window and then you can try to reload this page.',
  ...
  'certex_a1' =>'<p> This particular theorem was created in honour of Quentin Cooper, who interviewed us for the BBC Radio 4 science magazine programme Material World on 15th April 2010. The certificate above is different from the one originally presented  to Quentin. We have updated it into the format of the certificates we currently issue to customers.  In particular, we have now standardised the way we name the various mathematical expressions.  </p> <p> Following the name of the theorem, <em>Quentin\'s Theorem</em>,the certificate contains, in turn: the definition of a new kind of mathematical object, <em>T</em>; the definition of a new mathematical function, <em>f<sub>&#945</sub></em>; and the statement of the theorem.</p> <p> One way to envisage <em>T</em> is as four copies of the non-negative whole numbers 0, 1, 2, 3, ..., each copy in a different colour, say red, blue, green and yellow: <span style="color:#FF0000">0, 1, 2, 3, ...</span>, <span style="color:#0000FF">0, 1, 2, 3, ...</span>, etc.  So each member of <em>T</em> has both a numerical value and a colour.  <em>f<sub>&#945</sub></em> is then a kind of addition on these numbers. Its inputs are two coloured numbers and its output is a third coloured number, whose numerical value is the sum of those of the inputs and whose colour is that of the <em>second</em> input.</p><p> Note that, unlike regular addition, <em>f<sub>&#945</sub></em> is not commutative, that is its output depends on the <em>order</em> of its inputs. For instance, <em>f<sub>&#945</sub>(<span style="color:#FF0000">1</span>, <span style="color:#0000FF">2</span>)=
<span style="color:#0000FF">3</span></em> but <em>f<sub>&#945</sub>(<span style="color:#0000FF">2</span>, <span style="color:#FF0000">1</span>)=<span style="color:#FF0000">3</span></em>. Notice that the numerical values
of the outputs are the same, but the colours are different, as they
depend on the colour of the second input.</p><p> However, if we add three coloured numbers together, then the order
of the first two is immaterial. This is because the colour of the output will be that of the third input, so will not depend on the colours of the first two inputs. For instance,<em>
...
a restricted variant of commutativity.</p>
...
terms used in this explanation are also defined in the <a href="#glossary">glossary</a> at the end.</p>',
	...
	'certex_a2' => '<p> Both <em>T</em> and <em>f<sub>&#945</sub></em> are defined by<em>recursion</em>. This is a form of definition in which the body of the definition contains the thing being defined. This sounds circular, but it need not be. Consider, the following recursive definition of the, so called, <em>natural numbers</em>, i.e., the non-negative whole numbers 0, 1, 2, 3, .... </p> <p><center><em> N = 0 | s(N) </em></center></p><p> where <em>s</em> is called the <em>successor function</em>. This definitiongenerates a representation of the natural numbers of the form <em>0, s(0),s(s(0)), s(s(s(0))), ...</em>, where each application of <em>s</em> increases the number by 1. This representation is due to the mathematician <a href="http://en.wikipedia.org/wiki/Peano_axioms">Giuseppe Peano (1858-1932)</a>. The recursive definition consists of two cases: a base case <em>0</em> and a step case <em>s(N)</em>. Any particular natural number corresponds to one of these cases. Note that the step case contains <em>N</em>, which is the thing being defined. Think of this, not as a circle, but as a spiral.  <em>0</em> is at the centre of the spiral; each application of <em>s</em> winds the spiral out by a complete circuit. <em>0</em> and <em>s</em> are called <em>constructor functions</em>, because they are used to construct new types of mathematical objects, such as our four-coloured numbers. Note that constructor functions are <em>deliberately</em> not defined. They are taken as primitive mathematical objects and are used in the definitions of other mathematical objects and defined functions, such as +. Definitions have to stop unfolding at some point, and that point is with the constructor functions. </p><p> The boolean truth values, <em>true</em> and <em>false</em>, can be defined by a degenerate form of recursion, in which there are two base cases and no step cases: <em>B = true | false</em>. </p> <p> We will use <em>B</em> and <em>N</em> as the basis for defining new sets of recursively defined mathematical objects, such as <em>T</em> in our example certificate above. </p><p> The function <em>+</em> can also be defined recursively. It takes two members of <em>N</em> as inputs and returns one as output.  It also has a base case and a step case.</p><p><center><strong>Type:</strong> <em> + : N &times; N &rarr; N </em> </center></p> <p><center><strong>Base case:</strong> <em> 0+y = y </em></center></p> <p><center><strong>Step case:</strong> <em> s(x)+y = s(x+y) </em> </center></p> <p> The type line says that + takes two natural numbers as inputs and outputs one natural number. The base case and step case lines constitute the recursive definition of +. The recursion is on <em>x</em>, the first input of +. Note that, in the step case, the body of the definition also contains +, the function being defined. This is also not a circular definition, but a spiral one. This time the recursion spirals inwards. Starting with some particular value of <em>x</em>, say <em>s(s(o))</em>, the step case is applied to rewrite <em>s(s(0))+y</em> first to <em>s(s(0)+y)</em> and then to <em>s(s(0+y))</em>. Now the base case of the definition can be used to rewrite this as <em>s(s(y))</em> and the calculation is finished. Notice how the step case is organised so that + is applied to a smaller occurrence of <em>x</em> in the body of the definition than in the head. <em>N</em> has been defined to be <em>well founded</em>, which means that a sequence of its members cannot keepgetting smaller forever: sooner or later it will reach 0. This means that any calculation carried out using + will eventually stop. We can only apply the step case a finite number of times. Eventually, only the base case will be applicable and, after the base case, nothing will be applicable. To contrast functions such as + with the constructor functions, such as 0 and <em>s</em>, + is called a <em>defined function</em>. </p>',
	'certex_q3' => 'Defining four-coloured numbers',
	'certex_a3' => '<p>Our certificate introduces a new type of mathematical object called <em>T</em>, our four-coloured numbers. <em>T</em> is defined <a href="#recursion">recursively</a> as:</p> <p><center><em> T = C<sub>a</sub>(B,B) | C<sub>b</sub>(T) </em></center></p> <p> where <em>C<sub>a</sub></em> and <em>C<sub>b</sub></em> are new constructor functions.  <em> C<sub>a</sub></em> is a base constructor, since it does not have <em>T</em> among its inputs. It is analogous to the 0 constructor function of <em>N</em>, except that it has two inputs. These inputs are both members of <em>B</em>, i.e., they are one of two truth values: <em>true</em> and <em>false</em>. There are, therefore, four ways to instantiate <em>C<sub>a</sub></em>: <em>C<sub>a</sub>(true,true)</em>, <em>C<sub>a</sub>(true,false)</em>, <em>C<sub>a</sub>(false,true)</em> and <em>C<sub>a</sub>(false,false)</em>, i.e., there are four versions of 0. Above we envisaged these four versions of 0 as four differently coloured 0s, e.g., <em>C<sub>a</sub>(true,true)</em> could be envisaged as <span style="color:#FF0000">0</span> and <em>C<sub>a</sub>(true,false)</em> as <span style="color:#0000FF">0</span>. </p>
...
<em>C<sub>b</sub></em> are undefined primitives.</p>',
	'certex_q4' => 'Defining four-coloured addition',
	'certex_a4' => '<em>f<sub>&#945</sub></em> is a <a href="#recursion">recursively</a> defined function, whose definition is:</p>
...
it generates. </p>.',
	...
	'certex_a5' => '<p> On the certificate, Quentin\'s Theorem is said to be proved by "induction on <em>y</em>". What does this mean? </p>
...
induction and is left as an exercise for the reader. </p>',
	'certex_q6' => 'Variations on a theme',
	'certex_a6' => '<p> The <a href="#data-type">four-coloured numbers</a> described above are just
...
style="color:#0000FF">2</span>. </p>',
	...
	'certex_glossary' => '<p> We have collected together the definitions of some of the technical terms
...
also sometimes used to refer to this set of theorems.
	...
	'unlock_success' => 'Your account has been unlocked and you can now',
	'unlock_login' => 'You are already logged in. You need to <a href="?go=logout">logout</a> before you can unlock an account.',
	'unlock_failed1' => '<h2> Account Unlock Failed </h2> <p> Your account is either not locked, or has been locked again since you followed this link.</p> <p> If your account is unlocked, you can simply',
	'unlock_failed2' => 'Otherwise check your email. If you have forgotten your password you can make a',
	'unlock_failed3' => ' request to change your password',


	//report_name

	'repotname_title' => 'Abusive name report form.',
	'repotname_q1' => 'Why do you think this theorem name is abuvise?',
	'repotname_q2' => 'Your Email address:',
	'repotname_button' => 'Report',


	//change_pass

	'changepass_invalid' => 'You have used an invalid code or email address.</span> Perhaps this was a code from an old attempt to change your password. If you need to change your password, please enter your email address below and click on the "Request password change" button.',
	'changepass_emailsent1' => 'An email has been sent to ',
	 'changepass_emailsent2' =>' with a link that will allow your to change your password.</p> <p><span class=good>You should now check your email</span>.</p> <p>If you remember your old password, you can simply ignore the email, and',
	'changepass_passchanged' => 'Your password has been changed!',
	'changepass_login' => 'You can now login.',
	'changepass_return' => '<div class="backarrow"><a href="?">Return to overview</a></div> <div class="backarrow"><a href="?go=profile">Return to profile</a></div>',
	'changepass_blankpass' => 'You have to enter a blank password!',
	'changepass_doit' => 'You can now change your password.',
	'changepass_newpass' => 'Type in your new password:',
	'changepass_returnlogin' => 'Return to login page',
	'changepass_title' => 'This page allows you to request a change your TheoryMine password.',
	'changepass_p' => 'Once you have requested to change your password, we will email you with a special link that will let you type in a new password for your account.</p><p> If you remember your old password, you can simply ignore the email, and ',
	'changepass_loginasnormal' => 'login as normal.',
	'changepass_enteremail' => 'Enter the email address of your TheoryMine account',
	'changepass_requestpass' => 'Request password change',

	//gadgets

	'gadgets_title' => 'Gift Items for: ',
	'gadgets_p1' => 'You can now purchase TheoryMine T-shirts, mouse-pads and mugs!<br>All gift items are provided by <a href="http://www.zazzle.com/"  target="_blank">Zazzle</a> but are personalized with your TheoryMine theorems.',
	'gadgets_p2' => 'You can then choose which country you want your items to be shipped from (by choosing the closest country to you, you might get cheaper shipping costs). It is then possible to visit the TheoryMine gift shop where you can purchase items personalized with your selected theorem! Pick from lots of different styles, colors and sizes and costumize your items!',
	'gadgets_p3' => 'For more informations on your  purchase please refer to the instructions <a href="http://www.zazzle.com"  target="_blank">Zazzle</a> and to their <a href="http://www.zazzle.co.uk/mk/policy/user_agreement" target="_blank">User Agreement</a> and <a href="http://www.zazzle.co.uk/mk/policy/privacy_policy"  target="_blank">privacy policy</a>.',
	'gadgets_wherefrom' => 'Please select which country you would like to get your items shipped from:',
	'gadgets_selection' => 'You have selected:',
	'gadgets_go' => 'Go to the shop!',
	...
	'login_title' => 'Login to TheoryMine',
	'login_failed' => '<span class="warning">Login failed</span>, check your email address/login name and re-enter your password.</p><p>If you have forgotten your password, we can email you a link to ',
	'login_resetpassword' => 'reset your password',
	'login_waiting_email' => '<span class="warning">You need to read your email</span>, you have been emailed a link that you need in order to login. <p>This is because you  newly registered this address, or because you have changed your login details. <p> If you have lost the email we sent you, you can <a href="?go=change_pass">request a change of password</a> to get sent a new code with which you can login.',
	'login_noaccount' => 'Don\'t have an account?',
	'login_pass_forgot' => 'forgot your password? ',

	//register

	'register_title' => 'Register with TheoryMine',
	'register_p1' => 'Register with TheoryMine to get news about our products (e.g. forthcoming T-shirts and mouse-mats with your theorem, as well as an online journal!) and to see how your theorem(s) are related to other people\'s.',
	'register_missing_entry' => 'Please fill the fields marked with * and re-enter your password.',
	'register_mismatch' => 'Your passwords did not match, please re-enter it in the fields marked *.',
	'register_privacy' => 'Information on how we use the personal data that you submit on our site is contained in our <a href="?go=privacy">privacy and cookie policy</a>.',
	'register_retype1' => 'Retyped password:',
	'register_retype2' => 'please retype your password here',
	'register_nearly' => 'Thank you, registration is nearly complete. An email has been sent to: ',
	'register_checkemail' => 'The next thing you need to do is <span class="good">check your email</span>. The email contains a link to unlock your account and complete the registration process.',

	//profile

	'profile_login' => 'You need to <a href="?go=login">login</a> to access you TheoryMine profile',
	'profile_enterpass' => 'You need to enter your password to update your details.',
	'profile_wrongpass' => 'The password you enetred did not match your old password, enter your old password to update your details.',
	'profile_edit' => 'Edit Your Details:',
	'profile_needto' => 'To make changes you need to enter your ',
	'profile_good' => 'Details updated',
	'profile_return' => 'Return to overview',
	'profile_details' => 'Your Details:',
	'profile_changepass' => '(You can also change your password)',
	...
	'dicoveredthm_one' => 'You have named one theorem',
	'dicoveredthm_younamed'  => 'You have named ',
	...
	'progress_none' => 'You have no discoveries in progress, would you like to <a href="?go=discover">name a new theorem</a>?',
	'progress_one' => 'You have one discovery in progress:',
	'progress_youhave' => 'You have ',
	'progress_ndisc' => ' discoveries in progress:',
	'progress_placedon' => 'This order was placed on ',
	'progress_ordid' => 'and has order-id: ',
	...
	'header_tagline' => 'Personalized mathematical theorems',
	'header_next' => 'you could be next!',
	'header_new' => 'NEW!</font> <br/>You can now purchase <a href="?go=products#gift_items">TheoryMine T-shirts, mouse-pads and mugs!</a>',
	'header_clear' => 'clear messages',
	...
	'questionmark' => 'This is the name that will be given to your theorem forever. <br/> It can be either a name, a nick name or any other thing as long as it meets the following criteria:<br/><br/> - &nbsp It must be a no more than 30 characters long.<br/> - &nbsp It must NOT be inappropriate, libellous, defamatory, blasphemous, obscene, offensive to public morality or an incitement to racial hatred or terrorism. <br/><br/> Theorems names will be filtered and if reported and recognised to be inappropriate, they will be removed from our database and records without refund.',
	...
	'emailfooter_regards' => 'Regards from TheoryMine.',
	'emailfooter_emailus' => 'This email was sent by the TheoryMine: <a href="http://www.theorymine.co.uk/">http://www.theorymine.co.uk/</a><br> Got a question about TheoryMine? Email us at ',
	'emailfooter_please' => '<br>Please',
	'emailfooter_unsuscribe' => 'email us</a> if you would like to unsubscribe from TheoryMine.',
