...
$lang = array (
  ...
  'faq_q20' => '为什么你能声明数学定理能永久存在？',
    'faq_a1' => '您可以购买到新发现的数学定理的命名权。您将会收到一份PDF格式证书文档，文档内记载这该数学定理是如何被发现的。 这可以成为一份馈赠朋友的新奇礼物，或者书悬挂在书房内尽显书香门地证书，又或是吹牛利器？在礼品中心，您还可以购买到根据您的数学定理定制的相关产品，例如T恤以及鼠标垫等。',
  ...
  'faq_a3' => '当然可以！用您的账号登录我们的官方网站后，您可以在线购买与您的数学定理相关的小礼包，如体恤衫，马克杯或者鼠标垫等。',
  ...
  'faq_a6' => '在不具有侮辱，亵渎，色情，违反公共道德，具有煽动种族仇恨或者恐怖主义色彩的前提下，您可以给您的数学定理起任何您喜欢的名字。',
  ...
  'faq_a13' => 'TheoryMine证明函数的性质，比如加法函数中，加数以及被加数的顺序是不重要的，2+3 等于 3+2。 然而，减法函数就不一样了，2-3并不等于3-2，TheoryMine研发出一些像加法一样的数学函数，并研究一些类似参数的顺序是否重要等数学函数的性质。另外，一些函数是其他一些函数的逆运算。比如，加法和减法，加上一个数后减去同样一个数，结果将不变。TheoryMine也发掘一些函数的互逆性质。这些都是TheoryMine所涉及的经典的数学定理。请点击<a href="http://theorymine.co.uk/index.php?go=certificate_example">此链接</a>观看TheoryMine发现的定理及其详情说明的示例。', 
...
<li><strong>数学理论</strong> 是数学对象和相关函数的集合。它们间接地定义了定理的集合，因此理论有时也被认为是定理的集合。
	...
	'success' => '<h1> 恭喜您! </h1><p>您的订单已成功！<p/><p> 我们的机器数学家正在努力的为您工作着。通常需要48小时为您找到您的专属定理。 </p><p>当您的定理就绪的时候，您将收到一封确认信邮件。<br/></p>',
	...
	'changepass_emailsent2' => ' 该邮件中包含了能够更换密码的链接。</p> <p><span class=good>您现在可以确认您的邮件了</span>。</p> <p>如果您记得您的旧密码，您可以忽略该邮件',
	...
	'changepass_p' => '在您提交变更密码的申请后，您将收到我们发送的一封邮件，该邮件中包含了能够更换密码的链接。</p><p> 如果您记得您的旧密码，您可以忽略该邮件',
	...
	'gadgets_p2' => '您可以选择您所在地的国家或者离您所在地最近的国家，从而节省邮费。同时您也可以访问TheoryMine的礼品商店来购买与您的定理相关的个性化商品。 选择不同的款式，颜色以及大小并个性化您的商品！',
	...
	'questionmark' => '这个名字将永远和您的定理联系在一起。 <br/> 名字可以是人名，昵称或者任何符合如下要求的称呼:<br/><br/> - &nbsp 不得长于30个字。<br/> - &nbsp 不能含有不适当的，中伤，诽谤，亵渎的，淫秽的，攻击公共道德的或种族仇恨或具有恐怖主义煽动性的内容 <br/><br/> 定理的名字会经过审查，如果被发现或者举报该名字是不恰当的，他们将被从系统中移除并不提供任何补偿。',

	///*******EMAIL*************///

	//email_footer

	'emailfooter_regards' => 'TheoryMine敬上',
	'emailfooter_emailus' => '此邮件来自TheoryMine, 我们的主页 <a href="http://www.theorymine.co.uk/">http://www.theorymine.co.uk/</a><br> 对我们有任何疑问？请通过 ',
