...
'&#279;'=>'e'
  ...
  $thy_body_latex = replace_html_structure($thy_parts[1], $latex_remplacements);
  $thy_parts = preg_split('/\\\\\\\\/', $thy_body_latex);
  $thy_parts_base = preg_split('/\&=\&/', $thy_parts[0]);
  $thy_parts_step = preg_split('/\&=\&/', $thy_parts[1]);

  $datatype_latex = replace_html_structure($thy_parts2[0],
    $latex_remplacements);
  $datatype1_parts = preg_split('/\&=\&/', $datatype_latex);

  $function_type =  replace_html_structure($thy_parts2[1],
      $latex_remplacements);

  $thm_body_latex = replace_html_structure($thm_body,  $latex_remplacements);
  $thm_parts = preg_split('/\&=\&/', $thm_body_latex);


  $thm_title_latex =  replace_html_structure($thm_title,  $latex_remplacements);

  $data = [
    'theorem_title' => $thm_title_latex,
    'datatype_def_lhs' => $datatype1_parts[0],
    'datatype_def_rhs' => $datatype1_parts[1],
    'function_type' => $function_type,
    'function_def_base_lhs' => $thy_parts_base[0],
    'function_def_base_rhs' => $thy_parts_base[1],
    'function_def_step_lhs' => $thy_parts_step[0],
    'function_def_step_rhs' => $thy_parts_step[1],
    'theorem_lhs' => $thm_parts[0],
    'theorem_rhs' => $thm_parts[1],
    'short_proof' => $proof_body
  ];
